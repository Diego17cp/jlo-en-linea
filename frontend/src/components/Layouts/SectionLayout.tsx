	...
	return (
		<>
			<section className="mb-10 ml-5 flex gap-5 w-full md:w-2/3 justify-center md:justify-start items-center">
				<Link
					to="/"
					className="text-lg md:text-4xl text-primary font-titles hover:text-secondary transition-all duration-300 ease-in"
				>
				...
				{section && (
					<div className="flex gap-2 items-center">
						...
						/>
						<span className="text-lg md:text-3xl text-secondary font-titles">
							{section.title}
						</span>
					</div>
				)}
