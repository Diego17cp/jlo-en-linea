...
export const ServiceCard = ({ title, iconUrl, href } : Omit<Section, 'desc' | 'id'>) => {
    return (
        <a href={href} className="group-hover:opacity-60 hover:opacity-100 py-8 gap-8 px-5 flex flex-col items-center border-2 border-primary transition-all duration-300 ease-in-out rounded-lg shadow-md hover:shadow-lg hover:scale-110">  
