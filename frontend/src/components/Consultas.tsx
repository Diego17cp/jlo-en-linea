...
export const Consultas = () => {
	...
	const [consultData, setConsultData] = useState<LicenciasData | TransitoData | null>(null);
	...
	if (error || !consultData) {
		return (
			<div className="flex flex-col items-center justify-center h-full p-6">
				<div className="bg-red-100 border-l-4 border-red-500 p-6 rounded-lg max-w-2xl w-full">
					...
					<p className="mt-2 text-gray-700">ID consultado: {id}</p>
					<button
	...
	if (consultType === "transito") {
		...
		return (
			<div className="flex flex-col items-center justify-start h-full p-6 bg-gray-50">
